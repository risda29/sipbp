            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            <a href="<?php echo base_url('staff/beranda') ?>" class="nav-link <?php echo $page == 'Beranda' ? 'active' : '' ?>">
                        ...
                        <li class="nav-item menu-open">
                            <a href="<?php echo base_url('staff/kelola-peminjaman') ?>" class="nav-link <?php echo $page == 'Peminjaman' ? 'active' : '' ?>">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    Kelola Peminjaman
                                    <i class="right fas fa-angle-left"></i>
                        ...
                        <li class="nav-item menu-open">
                            <a href="<?php echo base_url('/logout') ?>" class="nav-link <?php echo $page == 'Logout' ? 'active' : '' ?>">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    Logout
                                    <i class="right fas fa-angle-left"></i>
