               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            <a href="<?php echo base_url('admin/beranda') ?>"
                                class="nav-link <?php echo $page == 'Beranda' ? 'active' : '' ?>">
                        ...
                        <li class="nav-item menu-open">
                            <a href="<?php echo base_url('admin/pengguna') ?>"
                                class="nav-link <?php echo $page == 'Pengguna' ? 'active' : '' ?>">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    pengguna
                                    <i class="right fas fa-angle-left"></i>
                        ...
                        <li class="nav-item menu-open">
                            <a href="<?php echo base_url('admin/kelas') ?>"
                                class="nav-link <?php echo $page == 'Kelas' ? 'active' : '' ?>">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    Kelas
                                    <i class="right fas fa-angle-left"></i>
                        ...
                        <li class="nav-item menu-open">
                            <a href="<?php echo base_url('admin/barang') ?>"
                                class="nav-link <?php echo $page == 'Barang' ? 'active' : '' ?>">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    Barang
                                    <i class="right fas fa-angle-left"></i>
