...
class PeminjamanController extends BaseController
{
    ...
    public function tambah()
    {
        $data = [
            ...
            'barang' => $this->BarangModel->where('status_barang !=', 'dipinjam')-> where('kondisi_barang !=', 'tidak layak')->findAll(),
    ...
    public function simpan()
    {
        ...
        $validation->setRules([
            ...
            'tenggat_peminjaman' => 'required|valid_date',
        ...
        for ($i = 0; $i < $jumlahBarang; $i++) {
            ...
            $this->BarangModel->update($idBarang[$i], ['status_barang' => 'dipinjam']);
            
            // Simpan data barang peminjaman ke database
